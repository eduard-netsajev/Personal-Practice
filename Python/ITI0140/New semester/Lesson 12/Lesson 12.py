...
def pair_frequency(words_list):
    ...
    for word in words_list:
        ...
        for i in range(1, len(word)):
            ...
            if first_index < 27 and second_index < 27:
                matrix[first_index][second_index] += 1
    return matrix


def create_heat_map(data_matrix):
...
def main():
    my_file = open("pg3070.txt")
    input_list = [word for word in gen_word(my_file)]
    create_heat_map(pair_frequency(input_list))
